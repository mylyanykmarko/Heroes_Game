package characters;//package im.delight.java.emoji;
...
/**
 * Lets you replace all emoticons in a text with their corresponding Unicode characters.Emoji
 * <p>
 * Usage: String myEmojiString = characters.Emoji.replaceInText(myString);
 */
public class Emoji {
	...
	/**
	 * Replaces all emoticons in the given text with their corresponding Unicode characters.Emoji
	 *
	 * @param text the String to search and replace in
	 * @return the new String containing the Unicode characters.Emoji
	 */
	...
	/**
	 * Converts between emoticons and their corresponding Unicode characters.Emoji in the given text
	 *
	 * @param text the String to search and replace in
